...
def rasterize_to_visibilities(
    ...
    n_hit_pixels, opacity_scores, alpha_scores, visibility_scores = _make_lazy_cuda_func(
        "rasterize_to_visibilities"
    )(
        means2d,
        conics,
        opacities,
    ...
    return n_hit_pixels, opacity_scores, alpha_scores, visibility_scores
