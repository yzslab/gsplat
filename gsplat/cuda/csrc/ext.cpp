...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("compute_sh_sc_decomposed_fwd", &gsplat::compute_sh_sc_decomposed_fwd_tensor);
    m.def("compute_sh_sc_decomposed_bwd", &gsplat::compute_sh_sc_decomposed_bwd_tensor);
    ...
    m.def("rasterize_to_pixels_hessian_approximation_bwd", &gsplat::rasterize_to_pixels_hessian_approximation_bwd_tensor);
    ...
    m.def("rasterize_to_vis_aware_weights", &gsplat::rasterize_to_vis_aware_weights_tensor);
}
